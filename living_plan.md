...
### Phase 224: Syndicate SWF CDO Tranche Co-Investment Yield-Hedging Option Secondary Market Liquidity matching restrictions (Completed)
...
### Phase 229: Syndicate SWF Sovereign Debt CDO Tranche Co-Investment Yield-Hedging Option Secondary Market Dynamic Volatility Arbitrage Spread Penalty Cap (Completed)
- [x] Define dynamic spread penalty cap structures in option dynamic spread policies (`AF-251`).
...
### Phase 233: Syndicate SWF Sovereign Debt CDO Tranche Co-Investment Yield-Hedging Option Secondary Market Market Maker Liquidity Buffer Dynamic Interest Surcharges Auto-Restock and Compound Faction Standing-Gated Discount Scaling Cooldown & Panic Override (Completed)
- [x] Define panic override proposal and voting schemas for surcharge standing discounts (`AF-255`).
...
### Phase 239: Syndicate SWF Sovereign Debt CDO Tranche Co-Investment Yield-Hedging Option Secondary Market Market Maker Liquidity Buffer Dynamic Interest Surcharges Auto-Restock and Compound Faction Standing-Gated Discount Scaling Cooldown & Panic Override Extension Cancellation Grace Period Minimum Liquidity Threshold Adjustment Fee Calibration (Completed)
- [x] Define surcharge panic override extension cancellation grace period minimum liquidity threshold adjustment fee calibration proposal and voting schemas (`AF-261`).
