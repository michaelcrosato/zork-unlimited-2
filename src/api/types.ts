...
export type Action =
  ...
  | { type: "ADJUST_SWF_REINSURANCE_OPTION_MARGIN"; syndicateId: string; swfYieldCdoId: string; trancheId: "senior" | "mezzanine" | "equity"; liquidationThreshold: number; penaltyRate: number; autoDeleveragingThreshold?: number; marginDeflectionFactor?: number; timestamp: number }
  | { type: "ADJUST_SWF_REINSURANCE_OPTION_VOLATILITY_INSURANCE"; syndicateId: string; swfYieldCdoId: string; trancheId: "senior" | "mezzanine" | "equity"; deflectionRate: number; stabilizationThreshold: number; drawdownMultiplier: number; timestamp: number }
