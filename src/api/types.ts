...
export type Action =
  ...
  | { type: "GIVE_AGENT"; targetAgentId: string; item: string; timestamp: number }
  ...
  | {
      ...
      factionA: string;
      factionB: string;
      targetState?: "allied" | "hostile" | "neutral";
      timestamp: number;
    }
  ...
  | {
      ...
      tariffRate: number;
      timestamp: number;
      tariffWaiverThreshold?: number;
      tariffDiscountThreshold?: number;
    }
  ...
  | {
      ...
      guildId: string;
      tariffRate: number;
      exportPricingPolicy: "premium" | "discount" | "standard";
      timestamp: number;
    }
  ...
  | {
      ...
      syndicateId: string;
      reportId: string;
      intelType: "wiretap_log" | "transaction_map" | "raid_schedule";
      roomId: string;
      cost: number;
      timestamp: number;
    }
  | {
      ...
      roomId: string;
      targetType: "espionage_network" | "wiretap";
      reportId: string;
      timestamp: number;
    }
  ...
  | {
      type: "LAUNCH_MASTERMIND_CONTRACT";
      contractId: string;
      syndicateId: string;
      payoutArbitrageMultiplier: number;
      cost?: number;
      timestamp: number;
    }
  | {
      type: "PROPOSE_ENFORCER_DEFUNDING";
      syndicateId: string;
  ...
  | {
      type: "ESTABLISH_SHADOW_MARKET";
      shadowMarketId: string;
      roomId: string;
      syndicateId: string;
      cost?: number;
      timestamp: number;
  ...
  | {
      type: "LAUNCH_ARBITRAGE_CONTRACT";
      contractId: string;
      syndicateId: string;
      startRoomId: string;
      endRoomId: string;
  ...
  | {
      type: "ESTABLISH_TREATY_INFILTRATOR";
  ...
  | {
      ...
      groupId: string;
      removeCollateral: { agentId: string; collateralType: "safehouse" | "outpost"; collateralId: string };
      addCollateral?: { agentId: string; collateralType: "safehouse" | "outpost"; collateralId: string };
      timestamp: number;
    }
  | {
  ...
  | {
      ...
      cdoId: string;
      creatorSyndicateId: string;
      assets: Array<{ type: "loan" | "investment"; syndicateId: string; assetId: string }>;
      timestamp: number;
    }
  | {
  ...
  | {
      ...
      tradeId: string;
      cdsId: string;
      proposerSyndicateId: string;
      counterpartySyndicateId: string;
      role: "buyer" | "writer";
      goldPrice: number;
      timestamp: number;
    }
  ...
  | {
      ...
      minLoyaltyRank: "None" | "Bronze" | "Silver" | "Gold" | "Platinum";
      payoutRatio: number;
      timestamp: number;
    }
  | {
  ...
  | {
      ...
      proposalId: string;
      borrowerSyndicateId: string;
      lenderSyndicateId: string;
      amount: number;
      interestRate: number;
      termSteps: number;
      timestamp: number;
  ...
  | {
      ...
      proposalId: string;
      syndicateId: string;
      targetProposalFee: number;
      targetVoteFee: number;
      timestamp: number;
    }
  | {
  ...
  | {
      ...
      proposalId: string;
      syndicateId: string;
      targetProposalFeeCap: number;
      targetVoteFeeCap: number;
      timestamp: number;
    }
  | {
  ...
  | {
      ...
      proposalId: string;
      syndicateId: string;
      oracleReputationThreshold: number;
      forecastAccuracyFloor: number;
      oracleStake?: number;
      timestamp: number;
    }
  ...
  | {
      ...
      proposalId: string;
      syndicateId: string;
      baseSurchargeRate: number;
      poolDepthScalingFactor: number;
      timestamp: number;
    }
  | {
  ...
  | {
      ...
      proposalId: string;
      syndicateId: string;
      deflectionCap: number;
      emergencyRefundAllocationPercent: number;
      timestamp: number;
    }
  | {
  ...
  | {
      ...
      gracePeriodMultiplier?: number;
      creditRatingRecoveryMultiplier?: number;
      timestamp: number;
    }
  | {
  ...
  | {
      ...
      cdoId: string;
      syndicateId: string;
      targetTrancheId: "senior" | "mezzanine";
      allocationPercent: number;
      timestamp: number;
    }
  | {
  ...
  | {
      ...
      cdoId: string;
      syndicateId: string;
      premiumPricingSpread: number;
      automatedHedgeEnabled: boolean;
      dynamicMatchingEnabled?: boolean;
      dynamicLiquidityFloor?: number;
      timestamp: number;
    }
  ...
  | {
      ...
      cdoId: string;
      syndicateId: string;
      spreadPenaltyMultiplier: number;
      spreadPenaltyCapMultiplier?: number;
      spreadPenaltyThresholdPercent: number;
      factionStandingDiscounts?: Record<string, number>;
      marketMakerSurchargeRate?: number;
      marketMakerSurchargeThresholdPercent?: number;
      marketMakerSurchargeAutoCompound?: boolean;
      marketMakerSurchargeCompoundTrancheId?: "senior" | "mezzanine" | "equity";
      marketMakerSurchargeFactionStandingDiscounts?: Record<string, number>;
      timestamp: number;
    }
  | {
  ...
  | {
      ...
      cdoId: string;
      targetProposalId: string;
      newMinLiquidityThreshold: number;
      timestamp: number;
    }
  | {
  ...
  | {
      ...
      syndicateId: string;
      cdoId: string;
      maxAutoReinvestYieldCap: number;
      timestamp: number;
    }
  | {
