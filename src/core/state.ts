...
export const SovereignDebtCDSCDOPoolSchema = z.object({
  ...
  accumulatedReinvestmentPool: z.number().int().nonnegative().optional(),
  autoReinvestThreshold: z.number().int().nonnegative().optional(),
  maxAutoReinvestYieldCap: z.number().int().nonnegative().optional(),
  tier1ReinvestmentThreshold: z.number().int().min(0).max(100).optional(),
  tier1Multiplier: z.number().min(1.0).optional(),
  tier2ReinvestmentThreshold: z.number().int().min(0).max(100).optional(),
  tier2Multiplier: z.number().min(1.0).optional(),
  reinvestmentSlashingThreshold: z.number().int().min(0).max(100).optional(),
  ...
  yieldHedgingOptionFeeBasePercent: z.number().min(0).max(1).optional(),
  yieldHedgingOptionFeeVolatilityScale: z.number().min(0).optional(),
  yieldHedgingOptionFeePartitionScale: z.number().min(0).optional(),
  yieldHedgingOptionFeeVolatilityThreshold: z.number().min(0).optional(),
  ...
  yieldHedgingOptionSpreadPenaltyCapMultiplier: z.number().min(1.0).optional(),
  ...
  yieldHedgingOptionMarketMakerSurchargeFactionStandingDiscounts: z.record(z.string(), z.number().min(0.0).max(1.0)).optional(),
});
...
export const SovereignDebtCDSCDOCoinvestmentReinvestmentPolicyProposalSchema = z.object({
  proposalId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
  tier1Threshold: z.number().int().min(0).max(100),
  tier1Multiplier: z.number().min(1.0),
  tier2Threshold: z.number().int().min(0).max(100),
  tier2Multiplier: z.number().min(1.0),
  slashingThreshold: z.number().int().min(0).max(100),
  slashingPenalty: z.number().min(0.0).max(1.0),
  status: z.enum(["proposed", "authorized", "disputed"]).optional(),
  resolved: z.boolean().optional(),
  proposerId: z.string(),
  timestamp: z.number().int(),
...
export type SovereignDebtCDSCDOCoinvestmentReinvestmentPolicyProposal = z.infer<typeof SovereignDebtCDSCDOCoinvestmentReinvestmentPolicyProposalSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionContractSchema = z.object({
  optionId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
  premiumPaid: z.number().int().nonnegative(),
  coverageAmount: z.number().int().positive(),
  strikeRate: z.number().nonnegative(),
  status: z.enum(["active", "settled", "expired"]),
  expiryStep: z.number().int().positive(),
  timestamp: z.number().int(),
});
export type SovereignDebtCDSCDOYieldHedgingOptionContract = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionContractSchema>;

export const SovereignDebtCDSCDOYieldHedgingPolicyProposalSchema = z.object({
  proposalId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
...
export const SovereignDebtCDSCDOYieldHedgingOptionFeeAdjustmentPolicyProposalSchema = z.object({
  proposalId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
  baseFeePercent: z.number().min(0).max(1),
  volatilityScale: z.number().min(0),
  partitionScale: z.number().min(0),
...
export type SovereignDebtCDSCDOYieldHedgingOptionFeeAdjustmentPolicyProposal = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionFeeAdjustmentPolicyProposalSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSpreadPolicyProposalSchema = z.object({
  proposalId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
  minSpread: z.number().min(0),
  maxSpread: z.number().min(0),
  status: z.enum(["proposed", "authorized", "disputed"]).optional(),
  resolved: z.boolean().optional(),
  proposerId: z.string(),
  timestamp: z.number().int(),
...
export const SovereignDebtCDSCDOYieldHedgingOptionSpreadPenaltyPolicyProposalSchema = z.object({
  ...
  spreadPenaltyCapMultiplier: z.number().min(1.0).optional(),
  ...
  marketMakerSurchargeFactionStandingDiscounts: z.record(z.string(), z.number().min(0.0).max(1.0)).optional(),
  status: z.enum(["proposed", "authorized", "disputed"]).optional(),
  resolved: z.boolean().optional(),
  proposerId: z.string(),
  timestamp: z.number().int(),
...
export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionProposalSchema = z.object({
  proposalId: z.string(),
  targetProposalId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
...
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionProposal = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionProposalSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionVoteSchema = z.object({
  proposalId: z.string(),
  vote: z.boolean(),
  timestamp: z.number().int(),
});
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionVote = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionVoteSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposalSchema = z.object({
  proposalId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
  targetProposalId: z.string(),
  ...
  timestamp: z.number().int(),
  remainingGraceSteps: z.number().int().nonnegative().optional(),
  graceDuration: z.number().int().nonnegative().optional(),
});
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposal = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposalSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVoteSchema = z.object({
  proposalId: z.string(),
  vote: z.boolean(),
  timestamp: z.number().int(),
});
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVote = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVoteSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposalSchema = z.object({
  proposalId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
  targetProposalId: z.string(),
  ...
  proposerId: z.string(),
  timestamp: z.number().int(),
  minLiquidityThreshold: z.number().optional(),
});
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposal = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposalSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceVoteSchema = z.object({
  proposalId: z.string(),
  vote: z.boolean(),
  timestamp: z.number().int(),
});
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceVote = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceVoteSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityProposalSchema = z.object({
  proposalId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
  targetProposalId: z.string(),
  minLiquidityThreshold: z.number().nonnegative(),
  status: z.enum(["proposed", "disputed", "authorized"]),
  proposerId: z.string(),
  timestamp: z.number().int(),
});
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityProposal = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityProposalSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityVoteSchema = z.object({
  proposalId: z.string(),
  vote: z.boolean(),
  timestamp: z.number().int(),
});
...
export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposalSchema = z.object({
  proposalId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
  newProposalFee: z.number().int().nonnegative(),
...
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposal = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposalSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVoteSchema = z.object({
  proposalId: z.string(),
  vote: z.boolean(),
  timestamp: z.number().int(),
});
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVote = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVoteSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposalSchema = z.object({
  proposalId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
  autoReinvestThreshold: z.number().int().nonnegative(),
...
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposal = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposalSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVoteSchema = z.object({
  proposalId: z.string(),
  vote: z.boolean(),
  timestamp: z.number().int(),
});
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVote = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVoteSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposalSchema = z.object({
  proposalId: z.string(),
  cdoId: z.string(),
  syndicateId: z.string(),
  maxAutoReinvestYieldCap: z.number().int().nonnegative(),
...
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposal = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposalSchema>;

export const SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVoteSchema = z.object({
  proposalId: z.string(),
  vote: z.boolean(),
  timestamp: z.number().int(),
});
export type SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVote = z.infer<typeof SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVoteSchema>;
...
export const GameStateSchema = z.object({
  ...
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionProposals: z.record(z.string(), SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionProposalSchema).optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionVotes: z.record(z.string(), z.record(z.string(), SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionVoteSchema)).optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals: z.record(z.string(), SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposalSchema).optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVotes: z.record(z.string(), z.record(z.string(), SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVoteSchema)).optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals: z.record(z.string(), SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposalSchema).optional(),
  ...
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposals: z.record(z.string(), SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposalSchema).optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVotes: z.record(z.string(), z.record(z.string(), SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVoteSchema)).optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposals: z.record(z.string(), SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposalSchema).optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVotes: z.record(z.string(), z.record(z.string(), SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVoteSchema)).optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposals: z.record(z.string(), SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposalSchema).optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVotes: z.record(z.string(), z.record(z.string(), SovereignDebtCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVoteSchema)).optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustProposalFee: z.number().int().nonnegative().optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustVoteFee: z.number().int().nonnegative().optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustBaseProposalFee: z.number().int().nonnegative().optional(),
  cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustBaseVoteFee: z.number().int().nonnegative().optional(),
...
export const createInitialState = (options: {
  ...
  return {
    ...
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionProposals: {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionVotes: {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals: {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVotes: {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals: {},
    ...
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposals: {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVotes: {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustProposalFee: 500,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustVoteFee: 100,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustBaseProposalFee: 500,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustBaseVoteFee: 100,
...
export function cloneStateWithoutHistory(state: GameState): GameState {
  ...
  const clone: GameState = {
    ...
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionProposals: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionProposals ? JSON.parse(JSON.stringify(rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionProposals)) : undefined,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionVotes: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionVotes ? JSON.parse(JSON.stringify(rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionVotes)) : undefined,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals ? JSON.parse(JSON.stringify(rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals)) : undefined,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVotes: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVotes ? JSON.parse(JSON.stringify(rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVotes)) : undefined,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals ? JSON.parse(JSON.stringify(rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals)) : undefined,
    ...
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposals: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposals ? JSON.parse(JSON.stringify(rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposals)) : undefined,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVotes: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVotes ? JSON.parse(JSON.stringify(rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVotes)) : undefined,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposals: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposals ? JSON.parse(JSON.stringify(rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposals)) : undefined,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVotes: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVotes ? JSON.parse(JSON.stringify(rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVotes)) : undefined,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposals: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposals ? JSON.parse(JSON.stringify(rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposals)) : undefined,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVotes: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVotes ? JSON.parse(JSON.stringify(rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVotes)) : undefined,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustProposalFee: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustProposalFee,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustVoteFee: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustVoteFee,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustBaseProposalFee: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustBaseProposalFee,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustBaseVoteFee: rest.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustBaseVoteFee,
  ...
  if (newState.cdsCdoCoinvestmentYieldReinvestmentProposals) {
    for (const [propId, prop] of Object.entries(newState.cdsCdoCoinvestmentYieldReinvestmentProposals)) {
      ...
      if (passed) {
        ...
        const mainProposal = newState.cdsCdoCoinvestmentProposals[prop.proposalId];
        if (mainProposal) {
          const oldShare = mainProposal.yieldReinvestmentShare ?? 0;
          const newShare = prop.yieldReinvestmentShare;
          mainProposal.yieldReinvestmentShare = newShare;

          const pool = newState.sovereignDebtCDSCDOPools[mainProposal.cdoId];
          const slashThreshold = pool?.reinvestmentSlashingThreshold ?? 10;
          const slashPenalty = pool?.reinvestmentSlashingPenalty ?? 0.1;

          if (newShare < slashThreshold && oldShare >= slashThreshold) {
            const contributions = mainProposal.contributions || {};
            const locked = mainProposal.lockedContributions || {};
            const lockedSyndicates = Object.keys(locked).filter(sId => locked[sId] === true);
            for (const sId of lockedSyndicates) {
              const rep = newState.factionRep[sId] ?? 0;
              const slash = Math.round(rep * slashPenalty);
              newState.factionRep[sId] = Math.max(0, rep - slash);
              if (!newState.journal) newState.journal = [];
              newState.journal.push(
                `[CDO Co-investment Reinvestment Slash] Syndicate ${sId}'s reputation slashed by ${slash} (${slashPenalty * 100}%) due to yield reinvestment share being reduced below ${slashThreshold}% (Old: ${oldShare}%, New: ${newShare}%).`
              );
            }
          }
        }
...
export function reconcileCDSCDOCoinvestmentReinvestmentPolicyProposals(state: GameState, pack: any): GameState {
  const newState = {
    ...state,
    cdsCdoCoinvestmentReinvestmentPolicyProposals: state.cdsCdoCoinvestmentReinvestmentPolicyProposals ? { ...state.cdsCdoCoinvestmentReinvestmentPolicyProposals } : {},
    sovereignDebtCDSCDOPools: state.sovereignDebtCDSCDOPools ? { ...state.sovereignDebtCDSCDOPools } : {},
    syndicates: state.syndicates ? { ...state.syndicates } : {},
  };

  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoCoinvestmentReinvestmentPolicyProposals)) {
    if (proposal.resolved || proposal.status === "authorized" || proposal.status === "disputed") continue;
    ...
    if (trueVotes.length > totalMembers / 2) {
      newState.cdsCdoCoinvestmentReinvestmentPolicyProposals[proposalId] = {
        ...proposal,
        resolved: true,
        status: "authorized",
      };
      ...
      const pool = newState.sovereignDebtCDSCDOPools[proposal.cdoId];
      if (pool) {
        pool.tier1ReinvestmentThreshold = proposal.tier1Threshold;
        pool.tier1Multiplier = proposal.tier1Multiplier;
        pool.tier2ReinvestmentThreshold = proposal.tier2Threshold;
        pool.tier2Multiplier = proposal.tier2Multiplier;
        pool.reinvestmentSlashingThreshold = proposal.slashingThreshold;
        pool.reinvestmentSlashingPenalty = proposal.slashingPenalty;
      }

      if (!newState.journal) newState.journal = [];
      newState.journal.push(
        `[CDO Co-investment Reinvestment Policy Approved] Syndicate ${proposal.syndicateId} approved co-investment reinvestment policy proposal ${proposalId} for CDO ${proposal.cdoId} (T1: ${proposal.tier1Threshold}% -> ${proposal.tier1Multiplier}x, T2: ${proposal.tier2Threshold}% -> ${proposal.tier2Multiplier}x, Slash: <${proposal.slashingThreshold}% -> ${proposal.slashingPenalty * 100}% penalty).`
      );
    } else if (falseVotes.length >= totalMembers / 2) {
      newState.cdsCdoCoinvestmentReinvestmentPolicyProposals[proposalId] = {
        ...proposal,
...
export function reconcileCDSCDOYieldHedgingOptionPolicyProposals(state: GameState, pack: any): GameState {
  const newState = {
    ...state,
    cdsCdoYieldHedgingOptionPolicyProposals: state.cdsCdoYieldHedgingOptionPolicyProposals ? { ...state.cdsCdoYieldHedgingOptionPolicyProposals } : {},
    sovereignDebtCDSCDOPools: state.sovereignDebtCDSCDOPools ? { ...state.sovereignDebtCDSCDOPools } : {},
    syndicates: state.syndicates ? { ...state.syndicates } : {},
  };

  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoYieldHedgingOptionPolicyProposals)) {
    if (proposal.resolved || proposal.status === "authorized" || proposal.status === "disputed") continue;
...
export function reconcileCDSCDOYieldHedgingOptionFeeAdjustmentPolicyProposals(state: GameState, pack: any): GameState {
  const newState = {
    ...state,
    cdsCdoYieldHedgingOptionFeeAdjustmentPolicyProposals: state.cdsCdoYieldHedgingOptionFeeAdjustmentPolicyProposals ? { ...state.cdsCdoYieldHedgingOptionFeeAdjustmentPolicyProposals } : {},
    sovereignDebtCDSCDOPools: state.sovereignDebtCDSCDOPools ? { ...state.sovereignDebtCDSCDOPools } : {},
    syndicates: state.syndicates ? { ...state.syndicates } : {},
  };

  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoYieldHedgingOptionFeeAdjustmentPolicyProposals)) {
    if (proposal.resolved || proposal.status === "authorized" || proposal.status === "disputed") continue;
    ...
    if (trueVotes.length > totalMembers / 2) {
      newState.cdsCdoYieldHedgingOptionFeeAdjustmentPolicyProposals[proposalId] = {
        ...proposal,
        resolved: true,
        status: "authorized",
      };
      ...
      const pool = newState.sovereignDebtCDSCDOPools[proposal.cdoId];
      if (pool) {
        pool.yieldHedgingOptionFeeBasePercent = proposal.baseFeePercent;
        pool.yieldHedgingOptionFeeVolatilityScale = proposal.volatilityScale;
        pool.yieldHedgingOptionFeePartitionScale = proposal.partitionScale;
        pool.yieldHedgingOptionFeeVolatilityThreshold = proposal.volatilityThreshold;
      }

      if (!newState.journal) newState.journal = [];
      newState.journal.push(
        `[CDO Yield-Hedging Option Fee Adjustment Policy Approved] Syndicate ${proposal.syndicateId} approved fee adjustment policy proposal ${proposalId} for CDO ${proposal.cdoId} (Base Fee: ${proposal.baseFeePercent * 100}%, Vol Scale: ${proposal.volatilityScale}, Part Scale: ${proposal.partitionScale}, Vol Threshold: ${proposal.volatilityThreshold}%).`
      );
    } else if (falseVotes.length >= totalMembers / 2) {
      newState.cdsCdoYieldHedgingOptionFeeAdjustmentPolicyProposals[proposalId] = {
        ...proposal,
...
export function reconcileCDSCDOYieldHedgingOptionSpreadPolicyProposals(state: GameState, pack: any): GameState {
  const newState = {
    ...state,
    cdsCdoYieldHedgingOptionSpreadPolicyProposals: state.cdsCdoYieldHedgingOptionSpreadPolicyProposals ? { ...state.cdsCdoYieldHedgingOptionSpreadPolicyProposals } : {},
    sovereignDebtCDSCDOPools: state.sovereignDebtCDSCDOPools ? { ...state.sovereignDebtCDSCDOPools } : {},
    syndicates: state.syndicates ? { ...state.syndicates } : {},
  };

  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoYieldHedgingOptionSpreadPolicyProposals)) {
    if (proposal.resolved || proposal.status === "authorized" || proposal.status === "disputed") continue;
    ...
    if (trueVotes.length > totalMembers / 2) {
      ...
      const pool = newState.sovereignDebtCDSCDOPools[proposal.cdoId];
      if (pool) {
        pool.yieldHedgingOptionMinSpread = proposal.minSpread;
        pool.yieldHedgingOptionMaxSpread = proposal.maxSpread;
      }

      if (!newState.journal) newState.journal = [];
      newState.journal.push(
        `[CDO Yield-Hedging Option Spread Policy Approved] Syndicate ${proposal.syndicateId} approved spread policy proposal ${proposalId} for CDO ${proposal.cdoId} (Min Spread: ${proposal.minSpread}, Max Spread: ${proposal.maxSpread}).`
      );
    } else if (falseVotes.length >= totalMembers / 2) {
      newState.cdsCdoYieldHedgingOptionSpreadPolicyProposals[proposalId] = {
        ...proposal,
  ...
  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoYieldHedgingOptionSpreadPenaltyPolicyProposals)) {
    ...
    if (trueVotes.length > totalMembers / 2) {
      ...
      if (pool) {
        ...
        pool.yieldHedgingOptionSpreadPenaltyCapMultiplier = proposal.spreadPenaltyCapMultiplier;
...
export function reconcileCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensions(state: GameState, pack: any): GameState {
  const newState = {
    ...state,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals } : {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionProposals: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionProposals ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionProposals } : {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionVotes: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionVotes ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionVotes } : {},
    syndicates: state.syndicates ? { ...state.syndicates } : {},
  };

  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionProposals)) {
    const syndicate = newState.syndicates[proposal.syndicateId];
    if (!syndicate) continue;

    const votes = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionVotes[proposalId] || {};
    const totalMembers = syndicate.members.length;
    ...
    if (newlyAuthorized) {
      const targetProposal = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals[proposal.targetProposalId];
      if (targetProposal && targetProposal.status === "authorized") {
        const currentEnd = targetProposal.cooldownEndStep ?? (newState.step + targetProposal.cooldownDuration);
        newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals[proposal.targetProposalId] = {
          ...targetProposal,
          cooldownEndStep: currentEnd + proposal.extensionDuration,
          timestamp: Math.max(targetProposal.timestamp, newState.step),
        };
    ...
    newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionProposals[proposalId] = {
      ...proposal,
      status,
      timestamp: Math.max(maxTimestamp, newState.step),
    };
...
export function reconcileCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellations(state: GameState, pack: any): GameState {
  const newState = {
    ...state,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals } : {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals } : {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVotes: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVotes ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVotes } : {},
    syndicates: state.syndicates ? { ...state.syndicates } : {},
  };

  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals)) {
    const syndicate = newState.syndicates[proposal.syndicateId];
    if (!syndicate) continue;

    const votes = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationVotes[proposalId] || {};
    const totalMembers = syndicate.members.length;
    ...
    if (newlyAuthorized) {
      const targetProposal = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals[proposal.targetProposalId];
      if (targetProposal && targetProposal.status === "authorized") {
        if (proposal.remainingGraceSteps !== undefined) {
          newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals[proposal.targetProposalId] = {
            ...targetProposal,
            cooldownEndStep: newState.step + proposal.remainingGraceSteps,
            timestamp: Math.max(targetProposal.timestamp, newState.step),
          };
        } else {
          newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals[proposal.targetProposalId] = {
            ...targetProposal,
            cooldownEndStep: undefined, // Terminate early by clearing cooldownEndStep
            panicOverrideActive: false, // Make it explicitly inactive
            timestamp: Math.max(targetProposal.timestamp, newState.step),
          };
        }
      }
    ...
    newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals[proposalId] = {
      ...proposal,
      status,
      timestamp: Math.max(maxTimestamp, newState.step),
    };
...
export function reconcileCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraces(state: GameState, pack: any): GameState {
  const newState = {
    ...state,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals } : {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals } : {},
    ...
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceVotes: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceVotes ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceVotes } : {},
    syndicates: state.syndicates ? { ...state.syndicates } : {},
  };

  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals)) {
    const syndicate = newState.syndicates[proposal.syndicateId];
    if (!syndicate) continue;

    const votes = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceVotes[proposalId] || {};
    const totalMembers = syndicate.members.length;
    ...
    if (newlyAuthorized) {
      const targetCancelProp = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals[proposal.targetProposalId];
      if (targetCancelProp) {
        newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationProposals[proposal.targetProposalId] = {
          ...targetCancelProp,
          remainingGraceSteps: proposal.graceDuration,
          graceDuration: proposal.graceDuration,
        };

        if (targetCancelProp.status === "authorized") {
          const overrideProp = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals[targetCancelProp.targetProposalId];
          if (overrideProp) {
            newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideProposals[targetCancelProp.targetProposalId] = {
              ...overrideProp,
              cooldownEndStep: newState.step + proposal.graceDuration,
              timestamp: Math.max(overrideProp.timestamp, newState.step),
            };
    ...
    newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals[proposalId] = {
      ...proposal,
      status,
      timestamp: Math.max(maxTimestamp, newState.step),
    };
...
export function reconcileCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidities(state: GameState, pack: any): GameState {
  const newState = {
    ...state,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals } : {},
    ...
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityVotes: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityVotes ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityVotes } : {},
    syndicates: state.syndicates ? { ...state.syndicates } : {},
  };

  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityProposals)) {
    const syndicate = newState.syndicates[proposal.syndicateId];
    if (!syndicate) continue;

    const votes = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityVotes[proposalId] || {};
    const totalMembers = syndicate.members.length;
    ...
    if (newlyAuthorized) {
      const targetGraceProp = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals[proposal.targetProposalId];
      if (targetGraceProp) {
        newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceProposals[proposal.targetProposalId] = {
          ...targetGraceProp,
          minLiquidityThreshold: proposal.minLiquidityThreshold,
        };
      }
    }

    newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityProposals[proposalId] = {
      ...proposal,
      status,
      timestamp: Math.max(maxTimestamp, newState.step),
    };
    ...
    for (const [transferId, transfer] of Object.entries(newState.cdsCdoYieldHedgingOptionTransfers)) {
      ...
      if (sellerPassed && buyerPassed) {
        ...
        if (option) {
          ...
          if (pool && pool.yieldHedgingOptionFeeBasePercent !== undefined) {
            const baseFee = pool.yieldHedgingOptionFeeBasePercent;
            const volScale = pool.yieldHedgingOptionFeeVolatilityScale ?? 0;
            const partScale = pool.yieldHedgingOptionFeePartitionScale ?? 0;
            const volThreshold = pool.yieldHedgingOptionFeeVolatilityThreshold ?? 0;
            ...
            const regionalStabilityIndex = Math.max(0, 1.0 - (avgVolatility / 100.0) - dropRate);
            const volDelta = Math.max(0, avgVolatility - volThreshold);

            const partitionPremium = dropRate * partScale;
            const volatilityPremium = volDelta * volScale * (1.0 - regionalStabilityIndex);

            feePercent = Math.min(1.0, baseFee + partitionPremium + volatilityPremium);
          }

          // Wire standing-gated fee waivers to waive transaction fees for Platinum-tier allied members
          if (pool) {
            const sellerSyndicateId = transfer.sellerSyndicateId;
...
export function reconcileCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrations(state: GameState, pack: any): GameState {
  const newState = {
    ...state,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposals: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposals ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposals } : {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVotes: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVotes ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVotes } : {},
    syndicates: state.syndicates ? { ...state.syndicates } : {},
  };

  let latestAuthorizedProposal: any = null;

  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposals)) {
    const syndicate = newState.syndicates[proposal.syndicateId];
    if (!syndicate) continue;

    const votes = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationVotes[proposalId] || {};
    const totalMembers = syndicate.members.length;
    ...
    newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationProposals[proposalId] = updatedProposal;
  ...
  if (latestAuthorizedProposal) {
    newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustProposalFee = latestAuthorizedProposal.newProposalFee;
    newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustVoteFee = latestAuthorizedProposal.newVoteFee;
    newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustBaseProposalFee = latestAuthorizedProposal.newProposalFee;
    newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustBaseVoteFee = latestAuthorizedProposal.newVoteFee;
  }

  return newState as GameState;
}

export function reconcileCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestments(state: GameState, pack: any): GameState {
  const newState = {
    ...state,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposals: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposals ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposals } : {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVotes: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVotes ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVotes } : {},
    sovereignDebtCDSCDOPools: state.sovereignDebtCDSCDOPools ? { ...state.sovereignDebtCDSCDOPools } : {},
    syndicates: state.syndicates ? { ...state.syndicates } : {},
  };

  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposals)) {
    const syndicate = newState.syndicates[proposal.syndicateId];
    if (!syndicate) continue;

    const votes = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentVotes[proposalId] || {};
    const totalMembers = syndicate.members.length;
    ...
    newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentProposals[proposalId] = updatedProposal;
...
export function reconcileCDSCDOYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCaps(state: GameState, pack: any): GameState {
  const newState = {
    ...state,
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposals: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposals ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposals } : {},
    cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVotes: state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVotes ? { ...state.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVotes } : {},
    sovereignDebtCDSCDOPools: state.sovereignDebtCDSCDOPools ? { ...state.sovereignDebtCDSCDOPools } : {},
    syndicates: state.syndicates ? { ...state.syndicates } : {},
  };

  for (const [proposalId, proposal] of Object.entries(newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposals)) {
    const syndicate = newState.syndicates[proposal.syndicateId];
    if (!syndicate) continue;

    const votes = newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapVotes[proposalId] || {};
    const totalMembers = syndicate.members.length;
    ...
    newState.cdsCdoYieldHedgingOptionSurchargePanicOverrideExtensionCancellationGraceLiquidityAdjustFeeCalibrationYieldProRataAutoReinvestmentGovernanceCapProposals[proposalId] = updatedProposal;
    ...
    if (status === "authorized") {
      ...
      if (pool) {
        newState.sovereignDebtCDSCDOPools[proposal.cdoId] = {
          ...pool,
          maxAutoReinvestYieldCap: proposal.maxAutoReinvestYieldCap,
        };
      }
    }
  }
